...
SECRET_KEY = 'django-insecure-)a%zb86j=*4yhzmwl^x@+8()kj&2@clni6=mst7096-_*@vjqb'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.social_media_links',
...
DATABASES = {
    ...
    #     'NAME': 'django',
    #     'USER': 'root',
    #     'PASSWORD': 'Ozm0JbWTJUv53DJ5VAzqSsGn',
    #     'HOST': 'mypostgresqldjango',
    #     'PORT': '5432',
    #     'OPTIONS': {
    #         'connect_timeout': 10,
    #     },
...
JAZZMIN_SETTINGS  = {    
    'site_header' : "Ali Momeni",
    'site_brand': 'Personal Webstie Admin',
